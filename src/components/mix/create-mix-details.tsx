  ...
  return (
    <Card className="w-full rounded-lg shadow-sm">
      <div className="p-6">
        {!detailsSaved && (
          <>
            ...
            <p className="text-muted-foreground mb-6">
              Complete your mix information so others can find and enjoy your
              music.
              {isProcessing &&
        ...
        {detailsSaved && isProcessing && (
          <div className="text-center py-8">
            <h2 className="text-2xl font-semibold mb-4">Processing your mix</h2>
            <p className="text-muted-foreground">
              Your mix details have been saved. We're finishing up the
              processing...
            </p>
          </div>
        )}

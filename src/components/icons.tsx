...
export const Icons = {
  ...
  discord: (props: LucideProps) => (
    <svg
        ...
        {...props}
    >
        <path d="M18 8.5a5 5 0 0 0-2.5-1 19.5 19.5 0 0 0-3.5 0 5 5 0 0 0-2.5 1A14 14 0 0 0 6 18.5c2 1 4 2 7 2s5-1 7-2a14 14 0 0 0-3.5-10Z" />
        <path d="M10.5 13a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0Z" />
        <path d="M16.5 13a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0Z" />
    </svg>
),
reddit: (props: LucideProps) => (
    ...
    >
        ...
        <path d="M16.2 7.8c.3-.4.2-.8-.2-1.3-.4-.4-.8-.5-1.3-.2" />
        <circle cx="16" cy="6" r="1" />
        <path d="M17 12a2 2 0 0 0-2-2 3 3 0 0 0-2 .9 3 3 0 0 0-2-.9 2 2 0 0 0-2 2c0 .9.7 1.7 1.5 1.9 1.3.3 2.8.4 4.5 0 .8-.2 1.5-1 1.5-1.9Z" />
        <path d="M8 14h.07c.9 1.46 2.4 2.35 3.93 2.35 1.53 0 3.03-.88 3.93-2.35" />

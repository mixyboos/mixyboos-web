...
import { ShowStatus } from '.'
import { Chat } from '../chat'
import { VideoPlayer } from '../players'
import { ActionButton, ProcessingStatus, TagLabel } from '../widgets'
...
const Show = ({ title, showId, showStatus, setShowStatus }: IShowProps) => {
  ...
  const [streamId, setStreamId] = React.useState(showId)
  ...
  return (
    <div className="mx-60">
      {!streamId && showStatus === ShowStatus.awaitingStreamConnection ? (

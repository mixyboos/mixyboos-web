...
import VideoPlayer from "@/components/widgets/video/video-player";
import UserImage from "@/components/widgets/user-image";
import { humanizeDate } from "@/lib/utils/time-utils";
          ...
          <div className="w-full shadow-xs">
            <div className="flex items-center justify-between border-t px-3 py-2 ">
              ...
              <div className="flex space-x-1 pl-0 sm:pl-2">
                ...
                >
                  <Icons.eye className="mr-0 h-5 w-5 " fill="currentColor" />
                  12

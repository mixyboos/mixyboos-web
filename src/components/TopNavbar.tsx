...
import { TKKEY } from "../services/api/apiClient";
      ...
      <div className="container flex flex-wrap items-center justify-between px-4 mx-auto">
        <div id="left-nav">
          <div className="relative flex justify-between lg:w-auto lg:static lg:block lg:justify-start">
            <Link href="/">
              <a className="inline-block py-2 mr-4 text-sm font-bold leading-relaxed text-gray-700 uppercase whitespace-nowrap">
                Mixy::Boos {count}
              </a>
            </Link>
            <button
          ...
          <ul className="flex flex-col list-none lg:flex-row lg:ml-auto">
            {authenticated && (
              <li className="flex items-center">
                <Link href="/live">
                  <a className="px-4 py-2 text-xs font-bold text-white uppercase transition-all duration-150 ease-linear bg-red-400 rounded shadow outline-none active:bg-blue-600 hover:shadow-lg focus:outline-none">
                    <svg
            ...
            {authenticated && (
              <li className="flex items-center">
                <Link href="/upload">
                  <a className="px-4 py-2 mb-3 ml-3 text-xs font-bold text-white uppercase transition-all duration-150 ease-linear bg-indigo-400 rounded shadow outline-none active:bg-blue-600 hover:shadow-lg focus:outline-none lg:mr-1 lg:mb-0">
                    <svg
                      className="inline-block w-3 h-3 mr-1 mb-0.5"
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
            ...
            <li className="flex items-center">
              <Link href="/debug">
                <a className="px-4 py-2 mb-3 ml-3 text-xs font-bold text-white uppercase transition-all duration-150 ease-linear rounded shadow outline-none bg-mixyboos active:bg-blue-600 hover:shadow-lg focus:outline-none lg:mr-1 lg:mb-0">
                  <svg
                    className="inline-block w-3 h-3 mr-1 mb-0.5"
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
            ...
            <ul className="flex flex-col list-none lg:flex-row lg:ml-auto">
              ...
              <li className="flex items-center">
                {user ? (
                  ...
                  <Link href="/login">
                    <a className="px-4 py-2 mb-3 ml-3 text-xs font-bold text-white uppercase transition-all duration-150 ease-linear bg-blue-500 rounded shadow outline-none active:bg-blue-600 hover:shadow-lg focus:outline-none lg:mr-1 lg:mb-0">
                      <svg
                        className="inline-block w-3 h-3 mr-1 mb-0.5"
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
